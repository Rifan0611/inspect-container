    ...
    <div className={`dashboard-layout theme-${theme}`}>
      ...
      <aside className={`sidebar ${sidebarOpen ? "open" : "closed"}`}>
        ...
        <div className="logo-section">
          <img src="/logo.jpg?v=2" alt="Logo" className="logo-box" style={{ width: "44px", height: "44px", background: "#ffffff", borderRadius: "10px", padding: "3px", border: "none", objectFit: "contain" }} />
